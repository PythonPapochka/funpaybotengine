...
class EventCollector:
    ...
    async def get_chat_changed_events(self, runner_response: RunnerResponse) -> TotalEvents:
        result = TotalEvents()
    ...
    async def make_order_events(self, total: TotalEvents):
        sales, purchases = {}, {}
