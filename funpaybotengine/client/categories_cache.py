...
class CategoriesCache:
    def __init__(self, categories: Sequence[Category]):
        ...
        self._subcategories_to_categories_mapping: dict[SubcategoryType, dict[int, Category]] = {
            i: {} for i in SubcategoryType
        }
    ...
    def get_subcategory_category(
        ...
        if subcategory is not None:
            return self._subcategories_to_categories_mapping[subcategory.type].get(subcategory.id)
